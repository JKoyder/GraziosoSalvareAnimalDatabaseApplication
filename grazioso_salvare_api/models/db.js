//Code sampled from: 
// Holmes, S. and Harber C. May 2019. Getting MEAN with Mongo, Express, Angular, and Node, Second Edition. Chapter 5.1. 
// Manning Publications. 

const mongoose = require('mongoose');
const host = process.env.DB_HOST || '127.0.0.1';
const dbURI = `mongodb://${host}/grazioso_salvare`;
